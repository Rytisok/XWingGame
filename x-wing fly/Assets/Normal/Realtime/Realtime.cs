...
#    endif
        ...
        private void Awake() {
            ...
            disp = GameObject.Find("Info").GetComponent<infoDisplay>();
        }
        ...
        private void Update() {
            ...
            if (_room != null) {
                ...
                disp.netInfo = "percentOfPacketsLost: " + Mathf.Round(_room.GetNetworkStatistics().percentOfPacketsLost).ToString() + "\n";
                disp.netInfo += "roundTripTime: " + Mathf.Round(_room.GetNetworkStatistics().roundTripTime).ToString() + " ms \n";
                disp.netInfo += "sentBandwidth: " + Mathf.Round(_room.GetNetworkStatistics().sentBandwidth).ToString() + " kbps \n";
                disp.netInfo += "receivedBandwidth: " + Mathf.Round(_room.GetNetworkStatistics().receivedBandwidth).ToString() + " kbps";
            }
        }
